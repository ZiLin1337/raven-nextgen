...
public class KeySetting extends Setting {
    ...
    public boolean isPressed() { return keyCode != 0 && org.lwjgl.glfw.GLFW.glfwGetKey(
            net.minecraft.client.MinecraftClient.MinecraftClient.getInstance().MinecraftClient.getInstance().MinecraftClient.getInstance().getWindow().getHandle(), keyCode) == 1; }
