...
public class MobESP extends Module {
    ...
    private void registerMobGroups() {
        ...
        registerMob("Baby Zombie", net.minecraft.entity.mob.ZombieEntity.class, e -> !((net.minecraft.entity.mob.ZombieEntity) e).isBaby() // was isVillager && ((net.minecraft.entity.mob.ZombieEntity) e).isBaby(), true, 0, 120, 255);
        ...
        registerMob("Donkey", net.minecraft.entity.passive.net.minecraft.entity.passive.HorseEntity.class, e -> ((net.minecraft.entity.passive.HorseBaseEntity) e).getHorseType() == 1, false, 120, 120, 120);
        registerMob("Elder Guardian", net.minecraft.entity.mob.GuardianEntity.class, e -> ((net.minecraft.entity.mob.GuardianEntity) e).isExperienceCamera() // was isElder, false, 0, 90, 140);
        ...
        registerMob("Guardian", net.minecraft.entity.mob.GuardianEntity.class, g -> !((net.minecraft.entity.mob.GuardianEntity) g).isExperienceCamera() // was isElder, false, 0, 150, 180);
        registerMob("Horse", net.minecraft.entity.passive.net.minecraft.entity.passive.HorseEntity.class, e -> ((net.minecraft.entity.passive.HorseBaseEntity) e).getHorseType() == 0, false, 150, 100, 60);
        ...
        registerMob("Mooshroom", net.minecraft.entity.passive.net.minecraft.entity.passive.MooshroomEntity.class, false, 200, 0, 0);
        registerMob("Mule", net.minecraft.entity.passive.net.minecraft.entity.passive.HorseEntity.class, e -> ((net.minecraft.entity.passive.HorseBaseEntity) e).getHorseType() == 2, false, 130, 110, 80);
        ...
        registerMob("Skeleton", net.minecraft.entity.mob.SkeletonEntity.class, e -> ((net.minecraft.entity.mob.SkeletonEntity) e)0 // getSkeletonType removed == 0, true, 255, 255, 255);
        registerMob("Skeleton Horse", net.minecraft.entity.passive.net.minecraft.entity.passive.HorseEntity.class, e -> ((net.minecraft.entity.passive.HorseBaseEntity) e).getHorseType() == 4, false, 220, 220, 220);
        ...
        registerMob("Wither Skeleton", net.minecraft.entity.mob.SkeletonEntity.class, e -> ((net.minecraft.entity.mob.SkeletonEntity) e)0 // getSkeletonType removed == 1, true, 55, 55, 55);
        registerMob("Wolf", net.minecraft.entity.passive.WolfEntity.class, false, 200, 200, 200);
        registerMob("Zombie", net.minecraft.entity.mob.ZombieEntity.class, e -> !((net.minecraft.entity.mob.ZombieEntity) e).isBaby() // was isVillager && !((net.minecraft.entity.mob.ZombieEntity) e).isBaby(), true, 0, 0, 255);
        registerMob("Zombie Horse", net.minecraft.entity.passive.net.minecraft.entity.passive.HorseEntity.class, e -> ((net.minecraft.entity.passive.HorseBaseEntity) e).getHorseType() == 3, false, 80, 100, 70);
        registerMob("Zombie Pigman", ZombieEntity.class, true, 255, 192, 203);
        registerMob("Zombie Villager", net.minecraft.entity.mob.ZombieEntity.class, e -> ((net.minecraft.entity.mob.ZombieEntity) e).isBaby() // was isVillager, true, 100, 140, 90);
    }
    ...
    private boolean shouldApplyChamsTo(LivingEntity entity) {
        ...
        if (outline.isToggled()) {
            runOutlinePass(e0.0f // partialTicks);
        }
        if (twoD.isToggled()) {
            for (Map.Entry<LivingEntity, Integer> entry : renderAsTwoD.entrySet()) {
                ...
                renderTwoD(entry.getKey(), col, 0, e0.0f // partialTicks);
            }
        }
    }
