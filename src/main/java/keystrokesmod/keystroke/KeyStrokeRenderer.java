...
public class KeyStrokeRenderer {
    ...
    public void render(DrawContext context) {
        ...
        context.drawText(mc.textRenderer, "W", x + 10, yOff + 5, 0xFFFFFFFF, true);
        yOff += 22;

        context.fill(x, yOff, x + 14, yOff + 14, 0x80000000);
        context.drawText(mc.textRenderer, "A", x + 3, yOff + 2, 0xFFFFFFFF, true);
        context.fill(x + 16, yOff, x + 30, yOff + 14, 0x80000000);
        context.drawText(mc.textRenderer, "S", x + 19, yOff + 2, 0xFFFFFFFF, true);
        yOff += 16;
